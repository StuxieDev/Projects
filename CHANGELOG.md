...
### Changed
- The README and CONTRIBUTING header logo is back to 300px wide. With the empty space trimmed in v0.3.2, the logo now fills that width, so it appears about 75% larger than before instead of the same size.
